    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
            ...
            <section className="relative hidden lg:flex items-center justify-center bg-gray-100 overflow-hidden">
                <div
                    aria-hidden
                    className="pointer-events-none absolute -top-40 -right-32 h-96 w-96 rounded-full bg-blue-900/10 blur-3xl"
                />
                <div
                    aria-hidden
                    className="pointer-events-none absolute -bottom-40 -left-32 h-96 w-96 rounded-full bg-red-600/10 blur-3xl"
                />
                ...
                <div className="relative z-10 w-full max-w-sm sm:max-w-md">
                    <div className="rounded-2xl bg-white/95 backdrop-blur shadow-2xl ring-1 ring-black/5">
                        ...
                        <form onSubmit={onSubmit} className="px-5 pt-5 pb-6 space-y-4 sm:space-y-5">
                            ...
                            <button
                                type="submit"
                                className="w-full h-11 sm:h-12 rounded-lg bg-red-600 text-white font-semibold shadow-sm transition hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-600/30"
                            >
                                Iniciar sesión
                            </button>
